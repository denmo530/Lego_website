...
<?php
		...
		function noResults(){
			print("<p class='noResults'>Vi kunde tyvärr inte hitta några resultat, vänligen försök igen!</p>");
		}
		...
		if($subSearch == 1){
			print("<p class='subSearch'>Vi hittade tyvärr inga resultat för '$searchText', men här är ett par sets som kanske intresserar dig!</p>");
		}
